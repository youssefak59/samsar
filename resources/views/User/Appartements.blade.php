...
<head>
    ...
    <title>Samsar.com</title>
    {{-- <link rel="application/octet-stream" href="{{ asset('css/style-user.scss') }}">
          ...
          <div class="row">
            <aside class="col-md-4">
              <article class="mr-3">
                ...
                <p
                  class="mt-3"
                >Some short text about company like You might remember the Dell computer commercials in which a youth reports this exciting news to his friends.</p>
                <div>
